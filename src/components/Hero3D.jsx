...
export default function Hero3D() {
  return (
    <section className="relative min-h-screen w-full bg-gradient-to-b from-neutral-900 via-black to-black text-white">
      {/* 3D Scene */}
      ...
      {/* Content */}
      <div className="relative z-10 mx-auto max-w-6xl px-4 pt-28 pb-28">
