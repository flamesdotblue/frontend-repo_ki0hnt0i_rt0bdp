      ...
      <div className="mx-auto max-w-7xl px-4">
        <nav className="mt-4 flex items-center justify-between rounded-2xl border border-white/10 bg-slate-900/40 p-3 backdrop-blur-xl">
          <a href="#home" className="group inline-flex items-center gap-2">
            <div className="relative h-7 w-7 rounded-xl bg-gradient-to-br from-cyan-400 to-fuchsia-500">
          ...
          <div className="hidden items-center gap-1 sm:flex">
            ...
            <a
              href="#contact"
              className="ml-2 inline-flex items-center justify-center rounded-full bg-gradient-to-r from-cyan-400 to-fuchsia-500 px-4 py-2 text-sm font-medium text-slate-900 shadow-[0_8px_30px_-12px_rgba(236,72,153,0.6)] transition hover:brightness-95"
            >
              Hire me
            </a>
          </div>
